const RAW_EXTERNAL_EVENTS = Object.freeze([
  ...
  { id: 'E04', category: 'ECONOMY', name: '주식시장 폭락', message: '소비 심리가 얼어붙었다.', effect: { demandMultiplier: 0.8, forcePhase: 'contraction', duration: 1 } },
  { id: 'E05', category: 'ECONOMY', name: '소비 진작 정책', message: '정부가 소비쿠폰을 뿌렸다.', effect: { demandMultiplier: 1.15, forcePhase: 'growth', duration: 1 } },
  ...
  { id: 'E11', category: 'CRISIS', name: '전쟁 발발', message: '주요 교역국에서 전쟁이 시작됐다.', effect: { costMultiplier: 1.3, demandMultiplier: 0.85, forcePhase: 'recession', duration: 3 } },
  { id: 'E12', category: 'CRISIS', name: '전쟁 종식', message: '전쟁이 끝나고 교역이 재개됐다.', effect: { costMultiplier: 0.8, demandMultiplier: 1.1, forcePhase: 'stable', duration: 2 } },
  { id: 'E13', category: 'CRISIS', name: '대규모 자연재해', message: '공장 지대에 재해가 발생했다.', effect: { orderCapMultiplier: 0.6, forcePhase: 'contraction', duration: 1 } },
  { id: 'E14', category: 'CRISIS', name: '전염병 확산', message: '소비 활동이 급감했다.', effect: { demandMultiplier: 0.75, forcePhase: 'contraction', duration: 2 } },
  ...
  { id: 'E20', category: 'MARKET', name: '경기 회복 뉴스', message: '긍정적인 경제 지표가 발표됐다.', effect: { demandMultiplier: 1.2, forcePhase: 'growth', duration: 1 } },
]);
